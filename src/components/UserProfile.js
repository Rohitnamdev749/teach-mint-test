...
import "../App.css";
const UserProfileComp = ({posts, timeZone}) => {
    ...
    {data && (
        <div className="user-profile">
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              <div style={{ backgroundColor: "black", color: "white", padding: "10px", borderRadius: "10px",margin:"10px" }}>{hours}:{minutes}:{seconds}</div>
              <button style={{margin:"10px"}}onClick={() => setIsStart(!isStart)}>start/pause</button>
            </div>
          </div>
